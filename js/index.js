...
(function(){
	var _d = JSON.parse(atob(''));
	for (var k in _d) {
		window[k] = _d[k];
	}
...
$("#text_w2025112834ed0a90b7961").find("._table_responsive").addClass("table").wrap($("<div />").addClass("table-responsive"));
		...
		function checkPermit(msg){
			if(confirm(msg)){
				SITE_MEMBER.openLogin('Lw%3D%3D', 'null', null, 'N');			}
		}
...
$("#text_w20251210a4a71fb3480fd").find("._table_responsive").addClass("table").wrap($("<div />").addClass("table-responsive"));
	...
	$(function(){
		...
		SITE_VISIT_LOG.addVisitLog(document.referrer,'4ZkbYEVPWh2nrqzGlw1dp5WUXR5+IQMaQt4+d+HFBNxncZO9OSGU25GO37vdqREyz4wmenPzLp9/qN6vpepWb8Umr/yr5AN0j7Frxp6FLnqCTmzQp2Rt58YcG2r8FTiG', '7043','m20251128451ef5a303407', first_visit_menu);
	});
