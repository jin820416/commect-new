...
(function(){
	var _d = JSON.parse(atob(''));
	for (var k in _d) {
		window[k] = _d[k];
	}
...
$("#text_w2025112834ed0a90b7961").find("._table_responsive").addClass("table").wrap($("<div />").addClass("table-responsive"));
		...
		function checkPermit(msg){
			if(confirm(msg)){
				SITE_MEMBER.openLogin('Lz9tb2RlPXBvbGljeQ%3D%3D', 'null', null, 'N');			}
		}
...
$("#text_w20251210a4a71fb3480fd").find("._table_responsive").addClass("table").wrap($("<div />").addClass("table-responsive"));
	...
	$(function(){
		...
		SITE_VISIT_LOG.addVisitLog(document.referrer,'4ZkbYEVPWh2nrqzGlw1dp5WUXR5+IQMaQt4+d+HFBNwc5K9GlbiBMJgtePD72hDVR9w24eRJIcOcPl7kmWwGc3spMgWlVIffPatahqH2Rnln0Fsg9K2pe9L6A0K1Pbed', '3733','m20251128451ef5a303407', first_visit_menu);
	});

$(function(){SITE.openPolicy();});